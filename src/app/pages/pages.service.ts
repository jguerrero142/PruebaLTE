...
export class PagesService {
  ...
  private taksObservable: BehaviorSubject<Taks[]> = new BehaviorSubject<Taks[]>(
    this.taks
  );
  ...
  getUsers() {
    return this.http.get<User[]>(`${this.API_URI}/usuario`).subscribe((d) => {
      (this.setUser = d), console.log(d);
    });
  }
}
